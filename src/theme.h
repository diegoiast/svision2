...
struct Theme {
    ...
    virtual auto draw_button(Bitmap &content, ButtonStates state, const std::string &text) -> void = 0;
};
...
struct ThemeOldie : Theme {
    ...
    virtual auto draw_button(Bitmap &content, ButtonStates state, const std::string &text) -> void override;
};
